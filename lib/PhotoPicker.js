...
var _CropView=require('./CropView');
...
translationAnimated:new _reactNative.Animated.Value(0),
isCroppingPhoto:false,
isTakingPhoto:false,
cropImagePath:null};return _this;
...
if(mode==='child'){
return(
_react2.default.createElement(_reactNative.View,{style:containerStyle,__source:{fileName:_jsxFileName,lineNumber:119}},
_react2.default.createElement(_CameraRollList2.default,_extends({},
this.props,{
onCrop:function onCrop(uri){
_this2.setState({
isTakingPhoto:true,
cropImagePath:uri});
...
return(
_react2.default.createElement(_reactNative.View,{style:[styles.container,containerStyle,hidden],__source:{fileName:_jsxFileName,lineNumber:142}},
_react2.default.createElement(_PresentationContext2.default,{
backgroundColor:contextColor,
opacity:contextOpacity,
animationDuration:animationDuration,
showContext:pickerState==='opened',
onPress:contextOnPress,__source:{fileName:_jsxFileName,lineNumber:143}}),

_react2.default.createElement(_reactNative.Animated.View,{
style:[
styles.pickerContainer,
{transform:[{translateY:yPosition}]}],__source:{fileName:_jsxFileName,lineNumber:150}},


_react2.default.createElement(_reactNative.View,{style:{width:width,height:height},__source:{fileName:_jsxFileName,lineNumber:156}},
this._renderPickerTopBar(),
_react2.default.createElement(_CameraRollList2.default,_extends({},this.props,{__source:{fileName:_jsxFileName,lineNumber:158}})))),
...
},__source:{fileName:_jsxFileName,lineNumber:162}},

_react2.default.createElement(_CropView.CropView,_extends({
cropRatio:this.props.outputImageAspectRatio,
imagePath:this.state.cropImagePath},
this.props,{
onFinishCropping:function onFinishCropping(base64Data){
...
}}]);return PhotoPicker;}(_react.Component);var _initialiseProps=function _initialiseProps(){var _this3=this;this._backEventHandler=function(){var dismissOnHardwareBackPress=_this3.props.dismissOnHardwareBackPress;var pickerState=_this3.state.pickerState;if(dismissOnHardwareBackPress&&pickerState==='opened'){_this3.dismiss();return true;}return false;};this._togglePicker=function(flag){var callback=arguments.length>1&&arguments[1]!==undefined?arguments[1]:function(){};var pickerState=flag===0?'animating':'opened';var toValue=flag;_this3.setState({pickerState:pickerState},function(){_reactNative.Animated.timing(_this3.state.translationAnimated,{toValue:toValue,duration:_this3.props.animationDuration}).start(function(completion){if(!completion.finished){var rollBack=flag===0?1:0;_this3.state.translationAnimated.setValue(rollBack);}if(pickerState==='animating'){_this3.setState({pickerState:'closed'});}});});};this._renderPickerTopBar=function(){var _props3=_this3.props,showTopBar=_props3.showTopBar,topBarComponent=_props3.topBarComponent;if(!showTopBar)return null;if(topBarComponent===null){return _react2.default.createElement(_TopBar.TopBar,_extends({},_this3.props,{onClose:function onClose(){_this3.dismiss();},onDone:function onDone(){_this3.dismiss();},__source:{fileName:_jsxFileName,lineNumber:93}}));}else{return topBarComponent;}};};
