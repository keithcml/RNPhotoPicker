...
console.log(base64);
_this.props.onFinishCropping(base64);
});
},_temp),_possibleConstructorReturn(_this,_ret);}_createClass(CropView,[{key:'render',value:function render()

{var _props=
this.props,cropRatio=_props.cropRatio,imagePath=_props.imagePath;
var cropHeight=width*cropRatio;
return(
_react2.default.createElement(_reactNative.View,{style:{flex:1},__source:{fileName:_jsxFileName,lineNumber:33}},
...
minZoom:20,
panToMove:true,
pinchToZoom:true,__source:{fileName:_jsxFileName,lineNumber:34}}),

_react2.default.createElement(_reactNative.TouchableOpacity,{
style:{padding:1,alignSelf:'stretch',height:GRID_SIZE},
onPress:this.crop,__source:{fileName:_jsxFileName,lineNumber:44}},

_react2.default.createElement(_reactNative.Text,{__source:{fileName:_jsxFileName,lineNumber:48}},'OK'))));
...
onFinishCropping:_propTypes2.default.func.isRequired};
