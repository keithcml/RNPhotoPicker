...
_react2.default.createElement(_reactNative.View,{style:{height:4},__source:{fileName:_jsxFileName,lineNumber:172}}),
_react2.default.createElement(_reactNative.Text,{style:{color:'lightgray',fontSize:13},__source:{fileName:_jsxFileName,lineNumber:173}},'Allow Accessing Your Photo Lirary')));


}else
if(_this.state.isLoadingNext||_this.state.connectingAlbum){
return(
_react2.default.createElement(_reactNative.View,{style:{paddingVertical:16,height:50,alignSelf:'stretch'},__source:{fileName:_jsxFileName,lineNumber:179}},
_react2.default.createElement(_reactNative.ActivityIndicator,{
animating:true,
size:'small',
color:'lightgray',__source:{fileName:_jsxFileName,lineNumber:180}})));



}
return _react2.default.createElement(_reactNative.View,{style:{height:40},__source:{fileName:_jsxFileName,lineNumber:188}});
};_this.
...
_react2.default.createElement(_CameraIcon.CameraIcon,{__source:{fileName:_jsxFileName,lineNumber:233}})));


};_this.
_renderItem=function(_ref3){var item=_ref3.item,index=_ref3.index;
if(index===0&&_this.props.hasCamera){
return _react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:239}},_this._renderCameraButton());
}
return(
...
if(_this.props.maxSelection===1){

if(_this.props.outputImageAspectRatio===null){

console.log('return image to caller');

return;
}
_this.props.onCrop(uri);
return;
}
...
return true;
},__source:{fileName:_jsxFileName,lineNumber:242}})));


};_this.state={connectingAlbum:true,isLoadingNext:false,hasNextPage:false,endCursor:'',photos:[],selected:{},noPhotoPermission:false,isTakingPhoto:false};_this._getPhotos();return _this;}_createClass(CameraRollList,[{key:'shouldComponentUpdate',value:function shouldComponentUpdate(nextProps,nextState){if(nextState.isTakingPhoto!==this.state.isTakingPhoto){return true;}if(nextState.photos===this.state.photos&&nextState.noPhotoPermission===this.state.noPhotoPermission){return false;}return true;}},{key:'render',value:function render()
{var _this2=this;
return(
_react2.default.createElement(_reactNative.View,{style:{flex:1},__source:{fileName:_jsxFileName,lineNumber:311}},
...
_react2.default.createElement(_CameraView.CameraView,_extends({
width:width},
this.props,{
...
},__source:{fileName:_jsxFileName,lineNumber:320}}))),
...
},__source:{fileName:_jsxFileName,lineNumber:334}})));
